...
<head>
    ...
    <!-- SITE META -->
    <title>Adertisement | AsiaUrdu</title>
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="widget">
                                            ...
                                            <div class="links-widget m30">
                                                <p>AsiaUrdu the flow of traffic. We offer effective advertisment and real traffic for youe business</p>
                                                <p>You can contact us for Advertisement. We have ad slot to grow your business.</p>
                                                <p>Contact: 92-302-8652233
                                                    <br>
                                                Email: asiaurdu1@gmail.com
                                                </p>
                                            </div>
                                            <!-- end links -->
                                        </div>
