...
$ob=new db_config();
$q=$_GET['q'];
$sql_q="SELECT * FROM `news_article` WHERE `aricle_permalink` LIKE '%$q%' ORDER BY article_id DESC";
                                    ...
                                    <div class="title-area">
                                        ...
                                        <div class="large-post-meta">
                                            <span class="avatar"><a href="author.html">
                                                <?php
                                    $article_user=$row_q['article_user'];
                                        $sql_get_user_name="SELECT * FROM `admin_login` WHERE admin_id=$article_user";
                                        $result_get_user_name=mysqli_query($ob->config(),$sql_get_user_name);
                                        $row_get_user_name=mysqli_fetch_assoc($result_get_user_name);
                                        echo '<img src="data:image/jpeg;base64,'.base64_encode($row_get_user_name['admin_profile_pic'] ).'" class="img-circle" alt="No Image" style="width:30px;height:30px;" >';
                                            echo $row_get_user_name['name'];
                                                ?>
                                            </a></span>
                                            <small>&#124;</small>
                                            <span><a href="category.html"><i class="fas fa-clock"></i>
                                                <?php
                                        ...
                                        ?>
                                            ...
                                            <span class="hidden-xs"><a href="single.html"><i class="fa fa-eye"></i>
                                                <?php
